...
// A dense-column variant (SignatureColumnDense, backed by DenseColumn from
// column.h) was prototyped here as a performance lever for problems with
// dense boundary matrices. Removed because it had drifted out of sync; recover
// from git history if you want to revive it: `git log -S SignatureColumnDense`.
